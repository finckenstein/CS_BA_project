...
class RecipesWithVideoStoredToDB:
    def __init__(self):
        PATH_TO_DB = '/home/leander/Desktop/automatic_KB/recipes/recipes_with_video_stored.db'
        PATH_TO_CSV = '/home/leander/Desktop/automatic_KB/recipes/recipes_with_video_stored.csv'
